/*This is the sample program to notify us for the file creation
and file deletion takes place in "/tmp" directory*/
#include <stdio.h>
#include <stdlib.h>
#include <errno.h>
#include <sys/types.h>
...
int main( )
{
	...
	* validate the existence of the directory before adding into
	monitoring list.*/
